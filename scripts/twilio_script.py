...
- Flood warning: "There is a flood warning in your area. Please move to higher ground immediately."
- Nearest shelter: "The closest shelter is at 123 Main St, open 24/7 during emergencies."
- Directions: "To reach the shelter, head north on River Road for 2 miles, then turn right onto Main St."
- Emergency contact: "For urgent help, call the local emergency number: 555-1234."
- Indian example: "Namaste! I see you are in India. Please tell me your city or locality so I can help you with flood safety tips and nearby shelters."
"""
)
VOICE = 'alloy'
LOG_EVENT_TYPES = [
